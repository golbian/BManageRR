...
module.exports = (app) => {
  ...
  router.get(
    ...
    events.findAllPmEvents
  );

  //Get All kam events
  router.get(
    "/kam/:kam",
    [authJwt.verifyToken, authJwt.isKam],
    events.findAllKamEvents
  );
  ...
  router.get(
    "/month/pm/:pm",
    [authJwt.verifyToken, authJwt.isPm],
    events.findAllPmEventsPerMonth
  );
  ...
  router.get(
    "/month/kam/:kam",
    [authJwt.verifyToken, authJwt.isKam],
    events.findAllKamEventsPerMonth
  );
  ...
  router.get(
    "/month/user/:user",
    [authJwt.verifyToken],
    events.findAllOwnerEventsPerMonth
  );
